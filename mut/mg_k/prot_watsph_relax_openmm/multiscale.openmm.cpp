...
int main(int argv, char **argc) {
  ...
  system.setDefaultPeriodicBoxVectors(OpenMM::Vec3(14.542,0,0), OpenMM::Vec3(0,14.184,0), OpenMM::Vec3(0,0,8.304));
...
#endif
  OpenMM::Discrete2DFunction *tf_C12 = new OpenMM::Discrete2DFunction(397, 397, C12values);
  OpenMM::Discrete2DFunction *tf_C6 = new OpenMM::Discrete2DFunction(397, 397, C6values);
