...
int main(int argv, char **argc) {
  ...
  system.setDefaultPeriodicBoxVectors(OpenMM::Vec3(15.351,0,0), OpenMM::Vec3(0,14.328,0), OpenMM::Vec3(0,0,8.748));
...
#endif
  OpenMM::Discrete2DFunction *tf_C12 = new OpenMM::Discrete2DFunction(492, 492, C12values);
  OpenMM::Discrete2DFunction *tf_C6 = new OpenMM::Discrete2DFunction(492, 492, C6values);
