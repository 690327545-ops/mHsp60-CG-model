...
int main(int argv, char **argc) {
  ...
  system.setDefaultPeriodicBoxVectors(OpenMM::Vec3(19.451,0,0), OpenMM::Vec3(0,18.062,0), OpenMM::Vec3(0,0,11.300));
...
#endif
  OpenMM::Discrete2DFunction *tf_C12 = new OpenMM::Discrete2DFunction(508, 508, C12values);
  OpenMM::Discrete2DFunction *tf_C6 = new OpenMM::Discrete2DFunction(508, 508, C6values);
