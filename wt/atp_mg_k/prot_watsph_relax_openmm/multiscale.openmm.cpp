...
// Compile option: g++ -O3 multiscale.openmm.cpp -lz -lOpenMM
...
int main(int argv, char **argc) {
  ...
  // MD data file
  gzFile gp = gzopen("multiscale.openmm.gz", "r");
  // OpenMM system:
  ...
  system.setDefaultPeriodicBoxVectors(OpenMM::Vec3(14.379,0,0), OpenMM::Vec3(0,15.278,0), OpenMM::Vec3(0,0,10.108));
...
#endif
  OpenMM::Discrete2DFunction *tf_C12 = new OpenMM::Discrete2DFunction(516, 516, C12values);
  OpenMM::Discrete2DFunction *tf_C6 = new OpenMM::Discrete2DFunction(516, 516, C6values);
  ...
  // Output dcd
  FILE *fp_dcd = fopen("multiscale.openmm.dcd", "wb");
  ...
  for (int i = 0; i < noutputs; i++) {
    ...
    // writeXYZ("multiscale.openmm.traj.xyz", positionsInNm);
  ...
  std::system("touch Stamp_OpenmmNormalEnd_multiscale");
