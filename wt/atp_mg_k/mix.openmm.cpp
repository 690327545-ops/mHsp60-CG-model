...
int main(int argv, char **argc) {
  ...
  system.setDefaultPeriodicBoxVectors(OpenMM::Vec3(17.818,0,0), OpenMM::Vec3(0,19.346,0), OpenMM::Vec3(0,0,13.095));
...
#endif
  OpenMM::Discrete2DFunction *tf_C12 = new OpenMM::Discrete2DFunction(519, 519, C12values);
  OpenMM::Discrete2DFunction *tf_C6 = new OpenMM::Discrete2DFunction(519, 519, C6values);
