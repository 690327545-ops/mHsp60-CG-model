...
int main(int argv, char **argc) {
  ...
  system.setDefaultPeriodicBoxVectors(OpenMM::Vec3(18.727,0,0), OpenMM::Vec3(0,18.041,0), OpenMM::Vec3(0,0,11.287));
...
#endif
  OpenMM::Discrete2DFunction *tf_C12 = new OpenMM::Discrete2DFunction(406, 406, C12values);
  OpenMM::Discrete2DFunction *tf_C6 = new OpenMM::Discrete2DFunction(406, 406, C6values);
